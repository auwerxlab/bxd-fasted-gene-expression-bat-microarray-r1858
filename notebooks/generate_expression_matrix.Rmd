...
run.metadata.url <- "https://sv-renku-git.epfl.ch/api/v4/projects/lisp%2Fbxd-fasted-knowledge-base/repository/files/data%2Fruns%2Fmicroarray_runs.txt/raw?ref=613ba382"
...
system(paste0("wget",
             ...
             " -O ", here('data/run_samples_fields_description.txt')))

# Filter out fields descriptions not present in samples metadata
read.table(here('data/run_samples_fields_description.txt'),
           sep = "\t", header = 1) %>%
